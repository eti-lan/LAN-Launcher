...
SET ONLINE_PASSWORD=
SET SERVER_PASSWORD=
SET GAME_MODE=R6AttackDefendGame
SET INITIAL_MAP=Mb01_Import
SET TIME_BETWEEN_ROUNDS=30
SET BRIEFING_TIME=5
...
:TAG_LAUNCH_SERVER
"local\Binaries\RainbowSixVegas2_SADS.exe" engine.servercommandlet %INITIAL_MAP%?AgO=%ONLINEPLAY%?AgU=%ONLINE_USERNAME%?AgP=%ONLINE_PASSWORD%?SrvOptionFile=%SERVER_OPTIONS_FILE%?TB=%BRIEFING_TIME%?TBR=%TIME_BETWEEN_ROUNDS%?GAME=R6Game.%GAME_MODE%?PW=%SERVER_PASSWORD%?HC=%HARDCORE%?RS=%RANDOMRESPAWN%
